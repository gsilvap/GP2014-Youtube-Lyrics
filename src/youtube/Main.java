...
public class Main {
	...
	private ArrayList<Video> populate() {
		...
		links.add(new Video("https://www.youtube.com/watch?v=hhG9ew_R02Y&index=9&list=PLwkJVLvVEfZgsrRS7oSy-N3lTcgIv1BO_"));
		...
		links.add(new Video("https://www.youtube.com/watch?v=4C7Fmg3_mkw&list=RD81_2Xb0XB_E&index=18"));
		...
		links.add(new Video("https://www.youtube.com/watch?v=Y3CjJ8iQmPk&end=120"));
		...
		links.add(new Video("https://www.youtube.com/watch?v=koPAFyLvil8&feature=related"));

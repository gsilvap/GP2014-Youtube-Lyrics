...
//	    			.substring(id.length()-11, id.length());
	...
	public ArrayList<String> downloadVideo() {
		return Utilities.runCmd("youtube-dl " + url, id);
	}

	public void downloadVideoByFormat(String format) {
		ArrayList<String> result = Utilities.runCmd("youtube-dl " + "-f " + format + " " + url, id);
...
//		TODO Verificar outros erros
	...
	public void downloadTitle() {
		ArrayList<String> result = Utilities.runCmd("youtube-dl --get-filename -o \"%(title)s\" " + id, id);		

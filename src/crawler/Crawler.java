...
//		Imprime todos os outputs para ficheiro
		...
		List<String> musics = Arrays.asList("James Arthur - Impossible (Lyrics)", "Bruno Mars -When I was your man (lyrics)", "Jason Mraz - I won't give up [lyrics]", "Rude Magic Lyrics", "A Thousand Years - Christina Perri Lyrics", "Boom Boom Pow - Black Eyed Peas (Lyrics)", "Oasis-Wonderwall lyrics", "Apologize - One republic (lyrics on screen)", "Green Day - Wake Me Up When September Ends (with lyrics on screen)", "The Fray - You Found Me (with lyrics) + HQ", "Fall For You Lyrics [ Secondhand Serenade]", "Invisible ~ Hunter Hayes ~ Lyrics", "OneRepublic-Counting Stars HD Lyrics Native!", "Taylor Swift - Blank Space AUDIO WORKING! (Lyrics + Download)", "Taylor Swift - Blank Space (Karaoke Version)", "Jessie J - Bang Bang ft. Nicki Minaj and Ariana Grande - Lyrics", "Beyonce Love On Top Lyrics HQ YouTube", "Rihanna - Stay feat. Mikky Ekko ~OFFICIAL LYRICS VIDEO~", "Thinking Out Loud by Ed Sheeran (LYRICS) Album Version", "Beyonce-Irreplaceable+lyrics", "Beyonce - Countdown (Lyrics Video) HD", "Nicki Minaj - Anaconda (Official - Lyrics Video)", "Emeli Sandé - Read All About It (pt III) [Lyrics On Screen]", "Hurt - Christina Aguilera + lyrics", "Nicki Minaj-Super Bass(lyrics) 2011(NEW)", "John Legend - All Of Me (Karaoke)", "Christina Perri - A Thousand Years (Karaoke Version)", "Dulce Pontes - Canção do Mar (Karaokê HQ)", "Eu Sei - Papas da Língua (KARAOKE COMPLETO)", "Rihanna - Stay [Karaoke/MCV]", "Bruno Mars - When I Was Your Man (Karaoke Ballad)", "Titanium - David Guetta ft. Sia (Karaoke/Instrumental)", "Hallelujah - Karaoke HD (In the style of Alexandra Burke)", "Keane - Everybody's Changing Karaoke.mp4", "Idina Menzel - Let It Go (from 'Frozen') (Karaoke Version)", "Ariana Grande Santa Tell Me Karaoke Lyrics", "Karaoke Rafiki Video Games - Lana Del Rey", "Clean Bandit and Jess Glynne - Rather Be (Karaoke Version)", "Hey Jude in the Style of \"The Beatles\" karaoke video with lyrics (no lead vocal)", "Beyonce Listen karaoke.wmv", "Katy Perry - Roar (Karaoke Version) HD", "Angie - The Rolling Stones Karaoke", "\"Robbie Williams\" (She's The One) - Karaoke", "Karaoke My Immortal - Evanescence *", "KARAOKE Decisiones Ruben Blades KARAOKE", "Echosmith - Cool Kids (Karaoke Version)", "Miley Cyrus - Wrecking Ball [ Karaoke / Instrumental ]", "Les Miserables - I Dreamed a Dream (Karaoke Instrumental) w/ Lyrics", "Tom Odell - Another Love (Karaoke Version)", "Karaoke - oasis stop crying your heart out");
		int count = 0;
